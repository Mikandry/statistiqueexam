            ...
            <div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
                <div class="border-b border-slate-200 p-5 md:p-6">
                    <div class="flex flex-wrap items-center justify-between gap-3">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <a class="rounded-lg border border-blue-300 bg-blue-50 px-3 py-2 text-sm font-medium text-blue-700 hover:bg-blue-100" href="{{ route('repartition.livre.controle.word', ['annee' => $filters['annee'], 'type_examen' => $filters['type_examen'], 'dren' => $filters['dren']]) }}">Export Word</a>
                ...
                <div class="p-5 md:p-6">
                    ...
                    <div class="mb-8 rounded-xl border border-indigo-200 bg-indigo-50/50 p-4">
                        ...
                        <p class="mb-3 text-xs text-indigo-700">Saisissez le nombre de compteurs par groupe (DREN ou CISCO). Le système répartit automatiquement les PE.</p>
