...
@section('title', 'Tableau de bord DREN (Liste) - Vacation 2026')
@section('content')
    ...
    <div class="space-y-4">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
            <div class="border-b border-slate-200 p-5 md:p-6">
                ...
                <p class="mt-1 text-sm text-slate-600">Statistiques par DREN - Vacation 2026</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 gap-4">
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm hover:shadow-md transition-shadow">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div class="flex-1">
                        <h3 class="text-lg font-semibold text-slate-900">{{ $dashboard['dren_name'] }}</h3>
                        <p class="text-sm text-slate-600 mt-1">
                            {{ $dashboard['cisco_count'] }} CISCO • 
                    ...
                    <a href="{{ route('vacation2026.dren', ['dren_id' => $dashboard['dren_id']]) }}" 
            ...
            <div class="rounded-2xl border border-slate-200 bg-slate-50 p-8 text-center">
                <p class="text-slate-600">Aucune DREN disponible</p>
            </div>
            @endforelse
        </div>
    </div>
