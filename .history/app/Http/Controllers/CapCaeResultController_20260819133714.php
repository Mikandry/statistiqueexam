...
class CapCaeResultController extends Controller
{
    ...
    private function freshBatch(CapCaeResultBatch $batch): CapCaeResultBatch
    {
        return CapCaeResultBatch::query()->findOrFail($batch->getKey());
    }
