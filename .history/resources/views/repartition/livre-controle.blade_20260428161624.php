    ...
    (function () {
        ...
        function getGroupData() {
            ...
            for (let i = 1; i <= groupCount; i++) {
                ...
                const regionsText = store[`${groupKey}|regions`] || '';
                const namesText = store[`${groupKey}|names`] || '';
                groups.push({
                    id: i,
                    regions: regionsText.split('\n').map(r => r.trim()).filter(r => r !== ''),
        ...
        function renderMatrix() {
            ...
            matrixBody.innerHTML = keys.map((key) => {
                ...
                const ranges = buildRanges(totalPe, compteurCount, names);
