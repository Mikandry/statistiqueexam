                                                    ...
                                                    <tr>
                                                        ...
                                                        @foreach($table['salles'] as $salle)
                                                            <td class="border border-slate-200 px-2 py-2 text-center">
                                                                {{ number_format((int) ($row['values'][$salle] ?? 0), 0, ',', ' ') }}
                                                            </td>
                                                        @endforeach
                                                    </tr>
                                                @endforeach {{-- This closes the rows loop --}}
                                            </tbody>
                                        </table>
                                    </div>
                                @endforeach {{-- This closes the tables loop --}}
                            </article>
                        @endforeach {{-- This closes the centres loop --}}
                        <div class="page-footer">
                            <div>Page {{ $pageNumber }} / {{ $allPages }}</div>
                            <div>produced by RAMAROSON Andry Michael V1.0</div>
                        </div>
