    ...
    <div class="page">
        ...
        <div class="chart-container">
            ...
            <svg width="100%" height="300" viewBox="0 0 800 300" xmlns="http://www.w3.org/2000/svg">
                ...
                @php
                    $maxCandidates = max(array_column($recapByDren, 'total_candidats'));
                    $barWidth = (700 - count($recapByDren) * 10) / count($recapByDren);
                    $barSpacing = 10;
                    $chartHeight = 230;
                    $x = 100;
                @endphp
        ...
        <table>
            ...
            <tbody>
                @php
                    $totalCandidatsLangues = array_sum(array_column($languesComparison, 'total_candidats'));
                @endphp
        ...
        <div class="chart-container">
            ...
            <svg width="100%" height="320" viewBox="0 0 500 320" xmlns="http://www.w3.org/2000/svg">
                ...
                @php
                    ...
                    $totalLangues = array_sum(array_column($languesComparison, 'total_candidats'));
                @endphp
        ...
        <table>
            ...
            <tbody>
                @php
                    $totalHandicap = array_sum($handicapByType);
                @endphp
