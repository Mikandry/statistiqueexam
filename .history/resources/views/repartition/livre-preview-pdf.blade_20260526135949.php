...
<head>
    ...
    <style>
        ...
        .summary-compact-table .summary-total {
            text-align: right;
            width: 1%;
            padding-left: 12px;
        }
                ...
                <div class="card centre-card">
                    ...
                    @foreach($centre['tables'] as $table)
                        <div class="centre-table-block">
                            @if(($filters['type_examen'] ?? '') === 'BEPC' || ($filters['type_examen'] ?? '') === 'CEPE' && $loop->first)
                                @php
                                ...
                                <div class="summary-compact">
                                    <table class="summary-compact-table">
                                        ...
                                        <tr>
                                            <td colspan="2" style="padding-top: 3px; white-space: normal;">
                                                GE problème (3PE): <strong>{{ count($centre['ge_distribution_probleme'] ?? []) }}</strong>
                                                | Répartition: <strong>{{ $geProblemeRepartition !== '' ? $geProblemeRepartition : '-' }}</strong>
                                                &nbsp;&nbsp;|&nbsp;&nbsp;
                                                GE autres matières (6PE): <strong>{{ count($centre['ge_distribution_autres'] ?? []) }}</strong>
