...
<div class="container">
    ...
    <form id="filters-form" method="GET" action="{{ route('repartition.centres.saisie') }}">
        <div class="row mb-3">
            <div class="col-md-4">
            ...
            <div class="col-md-4 d-flex align-items-end">
                ...
                <button type="button" id="apply-next-year" class="btn btn-outline-secondary ms-2">Année suivante</button>
            </div>
        </div>
    </form>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        var btn = document.getElementById('apply-next-year');
        if (!btn) return;
        btn.addEventListener('click', function () {
            var nextYear = (new Date()).getFullYear() + 1;
            var anneeInput = document.getElementById('annee');
            if (anneeInput) {
                anneeInput.value = nextYear;
            }
