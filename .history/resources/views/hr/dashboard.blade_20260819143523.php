...
<div class="space-y-6">
    ...
    <section class="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
        @foreach([['Agents actifs', $stats['total'], 'bg-slate-900 text-white'], ['Présents', $stats['present'], 'bg-emerald-600 text-white'], ['Congés', $stats['conge'] ?? 0, 'bg-blue-600 text-white'], ['Missions', $stats['mission'] ?? 0, 'bg-amber-500 text-white'], ['Formations', $stats['formation'] ?? 0, 'bg-violet-600 text-white'], ['Autorisations', $stats['autorisation_absence'] ?? 0, 'bg-orange-500 text-white'], ['Affectation temporaire', $stats['affectation_temporaire'], 'bg-cyan-600 text-white'], ['Sans affectation active', $stats['sans_affectation'], 'bg-white text-slate-900']] as [$label, $value, $class])
