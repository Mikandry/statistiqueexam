...
{{-- <p style="text-align:left">{{ $settings?->reference_prefix ?: 'N°' }} {{ $settings?->next_reference_number ?: 1 }}/{{ $settings?->reference_year ?: $today->year }}</p> --}}
<p style="text-align:left; !important">
    N°{{ $settings?->reference_year ?: $today->year }}/{{ $settings?->next_reference_number ?: 1 }}/{{ $settings?->reference_prefix ?: '' }}
</p>
