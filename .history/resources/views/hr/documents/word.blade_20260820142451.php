...
@if($title === 'Attestation de non-jouissance de congé')<p>Après vérification des registres disponibles, l’intéressé(e) n’a pas bénéficié de congé pendant {{ $period }}. La présente attestation est délivrée pour servir et valoir ce que de droit.</p>@else<p>La présente attestation est délivrée pour servir et valoir ce que de droit.</p>@endif
