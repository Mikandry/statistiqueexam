    ...
    <section class="overflow-hidden rounded-2xl border border-slate-200/70 bg-gradient-to-br from-white to-slate-50/80 shadow-md transition-all hover:shadow-lg">
        ...
        <div class="flex flex-wrap items-center justify-between gap-4 border-b border-slate-100 bg-gradient-to-r from-teal-50/70 to-emerald-50/40 p-5">
            <div>
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Générer des documents administratifs pour cet agent.
                </p>
            </div>
            <a
        ...
        <div class="grid gap-3 p-5 sm:grid-cols-3">
            ...
            @php
                $availableDocs = [
                    [
                        'slug' => 'non-interruption',
                        'label' => 'Non-interruption de service',
                        'icon' => '🔄',
                        'color' => 'border-cyan-200 bg-cyan-50 text-cyan-700',
                    ],
                    [
                        'slug' => 'non-jouissance',
                        'label' => 'Non-jouissance de congé',
                        'icon' => '📄',
                        'color' => 'border-slate-200 bg-slate-50 text-slate-700',
                    ],
                    [
                        'slug' => 'prise-service',
                        'label' => 'Fiche de prise de service',
                        'icon' => '🚀',
                        'color' => 'border-emerald-200 bg-emerald-50 text-emerald-700',
                    ],
                    [
                        'slug' => 'conge',
                        'label' => 'Fiche de congé',
                        'icon' => '🌴',
