        ...
        <nav class="app-sidebar-nav">
            ...
            @if(! $user?->isLogistique())
                <a class="{{ request()->routeIs('hr.*') ? $activeItem : $idleItem }}" href="{{ route('hr.dashboard') }}">
                    <span class="app-sidebar-icon-wrap bg-cyan-100 text-cyan-700">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M16 21v-2a4 4 0 00-4-4H6a4 4 0 00-4 4v2m6-6a4 4 0 100-8 4 4 0 000 8zm8-4h6m-3-3v6" /></svg>
                    </span>
                    <span class="app-sidebar-copy-block"><span class="app-sidebar-link-title">Ressources humaines</span><span class="app-sidebar-link-meta">Personnel et disponibilité</span></span>
                </a>
            @endif
            ...
            @if($user?->isAdmin())
                <a class="{{ request()->routeIs('admin.hr.*') ? $activeItem : $idleItem }}" href="{{ route('admin.hr.settings') }}">
                    <span class="app-sidebar-icon-wrap bg-cyan-100 text-cyan-700"><span class="text-sm font-black">RH</span></span>
                    <span class="app-sidebar-copy-block"><span class="app-sidebar-link-title">Paramètres RH</span><span class="app-sidebar-link-meta">En-têtes et lettres</span></span>
                </a>
            ...
            @if(! $user?->isLogistique())
                <a class="{{ request()->routeIs('cap-cae-results.*') ? $activeItem : $idleItem }}" href="{{ route('cap-cae-results.index') }}">
                    <span class="app-sidebar-icon-wrap bg-rose-100 text-rose-700">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5h6m-9 4h12M6 13h12M6 17h8M5 3h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2z" /></svg>
                    </span>
                    <span class="app-sidebar-copy-block"><span class="app-sidebar-link-title">Résultats CAP / CAE</span><span class="app-sidebar-link-meta">Admis et diplômes</span></span>
                </a>
