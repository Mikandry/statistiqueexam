...
<head>
    ...
    <style>
        ...
        /* Panneaux effet de verre (Glassmorphism) */
        .glass-panel {
        ...
        <main class="min-w-0 flex-1">
            <div class="glass-panel overflow-hidden rounded-[28px]">
                ...
                <div class="p-6 md:p-8 space-y-8">
                    ...
                    <!-- Section : Création de Référentiels -->
                    <div class="space-y-4">
                    ...
                    <!-- Section : Axes de Dispatching & Points de Largage -->
                    ...
                    <!-- Section : Maintenance / Filtres & Édition des Référentiels -->
                    <details id="zone-filtres-referentiels" class="ref-collapsible scroll-mt-24" open>
                        <summary class="flex items-center justify-between gap-4 px-6 py-5">
                            <div class="flex items-center gap-3">
                                <div class="p-2.5 rounded-xl bg-slate-900 text-teal-400">
                        ...
                        <div class="px-6 pb-6 pt-4 border-t border-slate-100">
                                ...
                                <div class="ref-table-wrap">
                                    <table class="ref-table w-full text-sm">
                                        ...
                                        @forelse($drensPage as $dren)
                                            <tr>
                                                <td>
                                                    <form method="POST" action="{{ route('admin.references.drens.update', $dren) }}" id="dren-update-form-{{ $dren->id }}">
                                                        @csrf
                                                        @method('PUT')
                                                ...
                                                <td class="text-right">
                                                    <div class="inline-flex items-center gap-2">
                                                        <button form="dren-update-form-{{ $dren->id }}" class="ref-btn-primary px-3 py-1.5 text-xs" type="submit">Modifier</button>
                                                        <form method="POST" action="{{ route('admin.references.drens.destroy', $dren) }}" onsubmit="return confirm('Supprimer la DREN {{ addslashes($dren->nom) }} et tout son héritage (CISCO, centres, statistiques) ?');" class="inline">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button class="ref-btn-danger px-3 py-1.5 text-xs" type="submit">Supprimer</button>
                                                        </form>
                                        ...
                                        @empty
                                            <tr><td class="text-slate-400 italic text-center py-4" colspan="2">Aucune DREN trouvée.</td></tr>
                                        @endforelse
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <!-- Table CISCO -->
                            <div class="mb-6">
                                <h3 class="mb-3 text-xs font-bold uppercase tracking-wider text-slate-600">CISCO</h3>
                                <div class="ref-table-wrap">
                                    <table class="ref-table w-full text-sm">
                                        <thead>
                                            <tr>
                                                <th class="text-left">DREN</th>
                                                <th class="text-left">Nom</th>
                                                <th class="text-right">Action</th>
                                            </tr>
                                        </thead>
                                        ...
                                        @forelse($ciscosPage as $cisco)
                                            <tr>
                                                <td>
                                                    <form method="POST" action="{{ route('admin.references.ciscos.update', $cisco) }}" id="cisco-update-form-{{ $cisco->id }}">
                                                        @csrf
                                                        @method('PUT')
                                                        <select class="ref-select" name="dren_id" required>
                                                            @foreach($drens as $dren)
                                                ...
                                                <td>
                                                        <input class="ref-input" name="nom" value="{{ $cisco->nom }}" required>
                                                    </form>
                                                </td>
                                                <td class="text-right">
                                                    <div class="inline-flex items-center gap-2">
                                                        <button form="cisco-update-form-{{ $cisco->id }}" class="ref-btn-primary px-3 py-1.5 text-xs" type="submit">Modifier</button>
                                                        <form method="POST" action="{{ route('admin.references.ciscos.destroy', $cisco) }}" onsubmit="return confirm('Supprimer le CISCO {{ addslashes($cisco->nom) }} et tous ses centres/statistiques ?');" class="inline">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button class="ref-btn-danger px-3 py-1.5 text-xs" type="submit">Supprimer</button>
                                                        </form>
                                        ...
                                        @empty
                                            <tr><td class="text-slate-400 italic text-center py-4" colspan="3">Aucun CISCO trouvé.</td></tr>
                                        @endforelse
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <!-- Table Centres de Correction -->
                            <div class="mb-6">
                                <h3 class="mb-3 text-xs font-bold uppercase tracking-wider text-slate-600">Centres de correction</h3>
                                <div class="ref-table-wrap">
                                    <table class="ref-table w-full text-sm">
                                        <thead>
                                            <tr>
                                                <th class="text-left">CISCO</th>
                                                <th class="text-left">Nom</th>
                                        ...
                                        @forelse($centresCorrectionPage as $cc)
                                            <tr>
                                                <td>
                                                    <form method="POST" action="{{ route('admin.references.centres-correction.update', $cc) }}" id="cc-update-form-{{ $cc->id }}">
                                                        @csrf
                                                        @method('PUT')
                                                ...
                                                <td>
                                                        <input class="ref-input" name="nom" value="{{ $cc->nom }}" required>
                                                </td>
                                                <td>
                                                ...
                                                <td class="text-right">
                                                    <div class="inline-flex items-center gap-2">
                                                        <button form="cc-update-form-{{ $cc->id }}" class="ref-btn-primary px-3 py-1.5 text-xs" type="submit">Modifier</button>
                                                        <form method="POST" action="{{ route('admin.references.centres-correction.destroy', $cc) }}" onsubmit="return confirm('Supprimer le centre de correction {{ addslashes($cc->nom) }} ({{ $cc->type_examen }}) et tous ses centres d\\'écrit/statistiques ?');" class="inline">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button class="ref-btn-danger px-3 py-1.5 text-xs" type="submit">Supprimer</button>
                                                        </form>
                                        ...
                                        @empty
                                            <tr><td class="text-slate-400 italic text-center py-4" colspan="4">Aucun centre de correction trouvé.</td></tr>
                                        @endforelse
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <!-- Table Centres d'Écrit -->
                            <div>
                                <h3 class="mb-3 text-xs font-bold uppercase tracking-wider text-slate-600">Centres d'écrit</h3>
                                <div class="ref-table-wrap">
                                    <table class="ref-table w-full text-sm">
                                        <thead>
                                            <tr>
                                        ...
                                        @forelse($centresEcritPage as $ce)
                                            <tr>
                                                <td>
                                                    <form method="POST" action="{{ route('admin.references.centres-ecrit.update', $ce) }}" id="ce-update-form-{{ $ce->id }}">
                                                        @csrf
                                                        @method('PUT')
                                                ...
                                                <td>
                                                        <input class="ref-input" name="nom" value="{{ $ce->nom }}" required>
                                                </td>
                                                <td>
                                                        <select class="ref-select" name="type_examen" required>
                                                ...
                                                <td class="text-right">
                                                    <div class="inline-flex items-center gap-2">
                                                        <button form="ce-update-form-{{ $ce->id }}" class="ref-btn-primary px-3 py-1.5 text-xs" type="submit">Modifier</button>
                                                        <form method="POST" action="{{ route('admin.references.centres-ecrit.destroy', $ce) }}" onsubmit="return confirm('Supprimer le centre d\\'écrit {{ addslashes($ce->nom) }} ({{ $ce->type_examen }}) et ses statistiques ?');" class="inline">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button class="ref-btn-danger px-3 py-1.5 text-xs" type="submit">Supprimer</button>
                                                        </form>
                                        ...
                                        @empty
                                            <tr><td class="text-slate-400 italic text-center py-4" colspan="4">Aucun centre d'écrit trouvé.</td></tr>
                                        @endforelse
                                        </tbody>
                                    </table>
                                </div>
