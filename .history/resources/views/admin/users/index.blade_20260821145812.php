                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full border-collapse text-sm">
                                ...
                                <tr class="bg-slate-100/80">
                                    ...
                                    <th class="border border-slate-200 px-3 py-2 text-left font-semibold">Dossier RH</th>
                                ...
                                @foreach($users as $user)
                                    <tr class="transition-colors duration-150 hover:bg-slate-50/80">
                                        ...
                                        <td class="border border-slate-200 px-3 py-2">
                                            @if($user->hrAgent)
                                                <span class="font-semibold text-emerald-700">{{ $user->hrAgent->full_name }}</span>
                                                <span class="block text-xs text-slate-500">{{ $user->hrAgent->matricule ?: 'Sans matricule' }}</span>
                                            @else
                                                <span class="text-xs text-slate-500">Aucun rattachement</span>
                                            @endif
                                        </td>
                                        <td class="border border-slate-200 px-3 py-2">
